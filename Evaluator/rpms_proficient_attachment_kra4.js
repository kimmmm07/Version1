    ...
    try {
        ...
        if (response.ok) {
            ...
            if(submitted['0'].is_checked === true){
                ...
                score1.value = content['12'].Score;
                score1.disabled = true;
                score2.value = content['13'].Score;
                score2.disabled = true;
                score3.value = content['14'].Score;
...
returnBtn.addEventListener('click', async function(){
    ...
    content['12'].Score = String(score1.value);
    content['13'].Score = String(score2.value);
    content['14'].Score = String(score3.value);
