...
const timeliness2Self = document.getElementById("TeacherTimeliness2_5");
const evaluatorTimeliness2 = document.getElementById("EvaluatorTimeliness2_5");
...
const timeliness9Self = document.getElementById("TeacherTimeliness9_5");
const evaluatorTimeliness9 = document.getElementById("EvaluatorTimeliness9_5");
...
async function getIPCRF(){
    ...
    try {
        ...
        if (response.ok) {
            ...
            timeliness9Self.innerHTML = `<input type="radio"   value="5" checked disabled>
            ${t_con3["9"]["TIMELINESS"]["Rate"]} - ${t_con3["9"]["TIMELINESS"][t_con3["9"]["TIMELINESS"]["Rate"]]}`;
            ...
            efficiency14Self.innerHTML = `<input type="radio"   value="5" checked disabled>
            ${t_con4["14"]["EFFICIENCY"]["Rate"]} - ${t_con4["14"]["EFFICIENCY"][t_con4["14"]["EFFICIENCY"]["Rate"]]}`;
            ...
            evaluatorTimeliness9.innerHTML = `<input type="radio"   value="5" checked disabled>
            ${e_con3["9"]["TIMELINESS"]["Rate"]} - ${e_con3["9"]["TIMELINESS"][e_con3["9"]["TIMELINESS"]["Rate"]]}`;
            ...
            evaluatorEfficiency14.innerHTML = `<input type="radio"   value="5" checked disabled>
            ${e_con4["14"]["EFFICIENCY"]["Rate"]} - ${e_con4["14"]["EFFICIENCY"][e_con4["14"]["EFFICIENCY"]["Rate"]]}`;
