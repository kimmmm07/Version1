...
async function toggleLike(postId, btn, post) { 
    ...
    if (likedPosts[postId]) {
        ...
        btn.innerHTML = `<i><img src="asset/Facebook Like.png" alt="Like Icon"></i> Like (${post.likes})`;
        btn.classList.remove('liked'); 
    } else {
        post.likes += 1;
        likedPosts[postId] = true;
        btn.innerHTML = `<i><img src="asset/Blue Like.png" alt="Like Icon"></i> Like (${post.likes})`; 
...
async function toggleLikeComment(commentId, btn, comment , post) { 
    if (likedPosts[commentId]) {
        ...
        btn.innerHTML = `<i><img src="asset/Facebook Like.png" alt="Like Icon"></i> Like (${comment.number_of_likes})`;
        btn.classList.remove('liked'); 
    } else {
        comment.number_of_likes += 1;
        likedPosts[commentId] = true;
        btn.innerHTML = `<i><img src="asset/Blue Like.png" alt="Like Icon"></i> Like (${comment.number_of_likes})`; 
        btn.classList.add('liked');  
...
function renderPosts() {
    ...
    posts.map((post) => {
        ...
        if (!post.is_liked) {
            likedPosts[postId] = false; 
            likeButton.innerHTML = `<i><img src="asset/Facebook Like.png" alt="Like Icon"></i> Like (${post.likes})`; 
        } else{
            likedPosts[postId] = true;
            likeButton.innerHTML = `<i><img src="asset/Blue Like.png" alt="Like Icon"></i> Like (${post.likes})`; 
        }
        ...
        commentButton.innerHTML = `<i><img src="asset/Chat Bubble.png" alt="Comment Icon"></i> Comment (${commentCount})`;
        ...
        sendButton.innerHTML = `<img src="asset/Paper_Plane.png" alt="Send Icon" class="send-icon">`;
        ...
        post.comments.map((comment) => {
            ...
            if (!comment.liked) {
                ...
                commentLikeButton.innerHTML = `<i><img src="asset/Facebook Like.png" alt="Like Icon"></i> Like (${comment?.number_of_likes})`; 
            } else{
                likedPosts[comment?.comment_id] = true;
                commentLikeButton.innerHTML = `<i><img src="asset/Blue Like.png" alt="Like Icon"></i> Like (${comment?.number_of_likes})`; 
            }
