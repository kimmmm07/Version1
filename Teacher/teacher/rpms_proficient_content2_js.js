    ...
    try {
        ...
        if (response.ok) {
            ...
            if(submit['0']['file_is_checked'] === true){
                ...
                document.getElementById('reflected-score').value = String(submit['0']['5']['Score']);
    ...
    try {
        ...
        if (response2.ok) {
            ...
            if(submit['0']['file2_is_checked'] === true){
                ...
                document.getElementById('reflected-score2').value = String(submit['0']['6']['Score']);
                unsubmitBtn2.style.display = 'none';
            }
        } else {
    ...
    try {
        ...
        if (response3.ok) {
            ...
            if (submit['0']['file3_is_checked'] === true) {
                document.getElementById('reflected-score3').value = String(submit['0']['7']['Score']);
                unsubmitBtn3.style.display = 'none';
            }
        } else {
