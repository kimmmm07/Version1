    ...
    try {
        ...
        if (response.ok) {
            ...
            if(submit['0']['is_checked'] === true){
                ...
                reflectedScoreKRA4.value = String(submit['0']['Overall Score']);
            }
    ...
    try {
        ...
        if (response.ok) {
            ...
            if(submit['0']['file_is_checked'] === true){
                ...
                document.getElementById('reflected-score').value = String(submit['0']['12']['Score']);
    ...
    try {
        ...
        if (response2.ok) {
            ...
            if(submit['0']['file2_is_checked'] === true){
                ...
                document.getElementById('reflected-score2').value = String(submit['0']['13']['Score']);
                unsubmitBtn2.style.display = 'none';
            }
        } else {
    ...
    try {
        ...
        if (response3.ok) {
            ...
            if (submit['0']['file3_is_checked'] === true) {
                document.getElementById('reflected-score3').value = String(submit['0']['14']['Score']);
                unsubmitBtn3.style.display = 'none';
            }
        } else {
...
closeSubmissionModal3.addEventListener('click', () => {
